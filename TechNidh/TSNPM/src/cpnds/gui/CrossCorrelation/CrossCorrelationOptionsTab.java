...
/**
 * @type     : Java Class
 * @name     : CrossCorrelationOptionsTab
 * @file     : CrossCorrelationOptionsTab.java
 * @created  : May 14, 2011 11:43:39 AM
 * @version  : 1.2
 */
public class CrossCorrelationOptionsTab extends MyPanel implements ActionListener{
    private MyRadioButton rb1 = new MyRadioButton("Start a new Cross Correlation Operation");
    private MyRadioButton rb2 = new MyRadioButton("Analyze recently acquired Data through Cross Correlation");
    private MyRadioButton rb3 = new MyRadioButton("Analyze multiple previous results");
    private ButtonGroup bGroup;
    /**
     * Constructor
     */
    public CrossCorrelationOptionsTab(){
        ...
        if(e.getActionCommand().equals("Start")){
            if(rb1.isSelected()){
                if(ADCAcquisitionData.newDataAvailable){
                    addMyPanel(new NewCrossCorrelationPanel(this));
                }else{
                ...
                addMyPanel(new AnalyzeCrossCoorelation(this));
            }else if(rb3.isSelected()){
                addMyPanel(new AnalyzeCrossCorrMultResults(this));
            }
