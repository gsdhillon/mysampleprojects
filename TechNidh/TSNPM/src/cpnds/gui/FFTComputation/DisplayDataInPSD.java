...
/**
 * @type     : Java Class 
 * @name     : DisplayDataInPSD
 * @file     : DisplayDataInPSD.java
 * @created  : May 29, 2011 4:31:14 PM
 * @version  : 1.2
 */
public class DisplayDataInPSD extends MyPanel implements ActionListener{
    private LineGraph lineGraph;
    private File dataFile = null;
    private File paramsFile = null;
    private String title = "Display Data in form of PSD";
    private MyLabel titleLabel;
    private String labelOfDataY = "PSD Component";
     ...
     * Constructor
     */
    public DisplayDataInPSD(AnalyzeFFTDataPanel parent){
    ...
    private void showFileData() {
        try{
            ...
            allPoints = FFTData.readData(dataFile,adcAcqParams,fftParams, FFTData.DISPLAY_PSD);
            //Cal MIN max and writing back removed on 11-08-11
            fftParams.setData(adcAcqParams);
            fftParams.setDisplayType(FFTData.DISPLAY_PSD);
