 ...
 * @author pradnya
 */
public class EarlyLateFormSevlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            switch (ReqType) {
                case "EarlyReport":
                    getEarlyLateReport(myHTTPConn, loginSession, "EarlyReport");
                    break;
                case "LateReport":
                    getEarlyLateReport(myHTTPConn, loginSession, "LateReport");
                    break;
                default:
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EarlyLateFormSevlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EarlyLateFormSevlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    private void getEarlyLateReport(MyHTTPConnection myHTTPConn, LoginSession loginSession, String reqType) {
        ...
        try {
            ...
            switch (reqType) {
                case "EarlyReport":
                    rptStatus = "'" + "XXE" + "'" + " or " + "muster.status=" + "'" + "XX#" + "'";
                    break;
                case "LateReport":
                    rptStatus = "'" + "XXL" + "'" + " or " + "muster.status=" + "'" + "XX#" + "'";
                    break;
            }
            ...
            Packetizer p;
            System.out.println("Early Late query : " + query);
