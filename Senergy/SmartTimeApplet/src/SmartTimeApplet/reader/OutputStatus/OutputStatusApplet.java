 ...
 * @author pradnya
 */
public class OutputStatusApplet extends MyApplet {
    ...
    public void init() {
        try {
            ...
            MyUtils.showException("Output Status", e);
        }
    }
    ...
    private MyPanel CreateHomePanel() throws Exception {
        ...
        getReaderMasterList();
        MyButton b = new MyButton("Output Status", 1) {
    ...
    private void OutputStatus() {
        ...
        contentPane.add(new OutputStatus(this, id, getReaderList()));
