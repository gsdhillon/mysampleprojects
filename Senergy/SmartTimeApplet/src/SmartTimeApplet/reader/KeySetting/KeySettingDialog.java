 ...
 * @author pradnya
 */
public class KeySettingDialog extends JDialog implements ActionListener {
    ...
    public KeySettingDialog(final KeySettingApplet applet, String selReader, int countReader) {
        super(new JFrame(), "Set Reader Keys", true);
        this.keySettingApplet = applet;
        ...
        Point p = applet.getLocationOnScreen();
    ...
    private String createPacket() {
        ...
        try {
            ...
            for (int i = 0; i < charkeyWord.length() - 1; i += 2) {
                ...
                String output = charkeyWord.substring(i, (i + 2));
                //convert hex to decimal
                int decimal = Integer.parseInt(output, 16);
                //convert the decimal to character
                strkeyword = strkeyword + ((char) decimal);
            }
