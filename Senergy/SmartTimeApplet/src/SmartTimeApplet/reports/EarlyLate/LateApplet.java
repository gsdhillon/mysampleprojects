 ...
 * @author pradnya
 */
public class LateApplet extends MyApplet {
    ...
    public void init() {
        try {
            ...
            EarlyLateGUI RG = new EarlyLateGUI(this, "LateReport", empCode);
                LoadPanel(RG);
        } catch (Exception e) {
            MyUtils.showException("LateReportApplet", e);
        }
    }
    ...
    public void showReportPanel(String Packet, String result, String divNamePacket, String rptType) {
        try {
            ...
            ReportTableView rtv = new ReportTableView(this, Packet, divNamePacket, "LateReport", rowCount, rptType);
    ...
    public TupleClass[] getTuples(String rptType, String divNamePacket, boolean Todays) throws Exception {
        ...
        if ("Division".equals(rptType) || "SingleDiv".equals(divNm)) {
            ...
            if (Todays == true) {
                ...
                tpl[5] = new TupleClass("LateBy", 80, MyTableColumn.TYPE_STRING);
            } else {
            ...
            if (Todays == true) {
                ...
                tpl[7] = new TupleClass("Login", 80, MyTableColumn.TYPE_STRING);
    ...
    private void showSelfReport() {
        try {
            ...
            contentPane.add(new SelfReport(this, "LateReport"), BorderLayout.CENTER);
    ...
    public void showMonthlyMuster(int index) {
        ...
        contentPane.add(new MonthlyMuster("LateReport", index), BorderLayout.CENTER);
        contentPane.validate();
        contentPane.repaint();
    }
}
