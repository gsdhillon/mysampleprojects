 ...
 */
package SmartTimeApplet.reports.OutDoorDuty;
...
public class OutDoorDutyApplet extends MyApplet {
    ...
    public void init() {
        try {
            ...
            ReportGUI RG = new ReportGUI(this, "OutDoorDuty", empCode);
            LoadPanel(RG);
        } catch (Exception e) {
            MyUtils.showException("OutDoorDuty", e);
        }
    }
    ...
    public void showReportPanel(String Packet, String result, String divNamePacket, String rptType) {
        try {
            ...
            ReportTableView rtv = new ReportTableView(this, Packet, divNamePacket, "OutDoorDuty", rowCount, rptType);
    ...
    private void showSelfReport() {
        try {
            ...
            contentPane.add(new SelfReport(this, "OutDoorDuty"), BorderLayout.CENTER);
    ...
    public void showMonthlyMuster(int index) {
        ...
        contentPane.add(new MonthlyMuster("OutDoorDuty", index), BorderLayout.CENTER);
        contentPane.validate();
        contentPane.repaint();
    }
}
