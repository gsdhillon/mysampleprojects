 ...
 * @author pradnya
 */
public class CreatePacketAttendance {
    
    private AttendanceGUI MR;
    private String packet = "";
    
    public CreatePacketAttendance(AttendanceGUI MR, String div, String section, String workL) {
        this.MR = MR;
        packet = Packet(div, section, workL);
    }
    
    public CreatePacketAttendance(AttendanceGUI MR, String checkHead) {
        this.MR = MR;
        packet = Packet(checkHead);
    }
    
    public CreatePacketAttendance(String[] name) throws Exception {
        packet = Packet(name);
    }
