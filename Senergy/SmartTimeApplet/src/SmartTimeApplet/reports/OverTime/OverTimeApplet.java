 ...
 */
package SmartTimeApplet.reports.OverTime;
 ...
 * @author pradnya
 */
public class OverTimeApplet extends MyApplet {
    ...
    public void init() {
        try {
            ...
            ReportGUI RG = new ReportGUI(this, "OverTimeApplet", empCode);
                LoadPanel(RG);

        } catch (Exception e) {
            MyUtils.showException("OverTimeApplet", e);
        }
    }
    ...
    public void showReportPanel(String Packet, String result, String divNamePacket, String rptType) {
        try {
            ...
            ReportTableView rtv = new ReportTableView(this, Packet, divNamePacket, "OverTimeApplet", rowCount, rptType);
            ...
            for (int i = 0; i < rowCount; i++) {
                ...
                for (int j = 0; j < col; j++) {
                    MyUtils.showMessage("OverTimeApplet");
    ...
    public TupleClass[] getTuples(String rptType, String divNamePacket) throws Exception {
        ...
        if ("Division".equals(rptType) || "SingleDiv".equals(divNm)) {
            ...
            tpl[5] = new TupleClass("TotalWrk", 80, MyTableColumn.TYPE_STRING);
            tpl[6] = new TupleClass("ExtraWrk", 80, MyTableColumn.TYPE_STRING);
            ...
            tpl[4] = new TupleClass("TotalWrk", 80, MyTableColumn.TYPE_STRING);
            tpl[5] = new TupleClass("ExtraWrk", 80, MyTableColumn.TYPE_STRING);
            ...
            tpl[6] = new TupleClass("TotalWrk", 80, MyTableColumn.TYPE_STRING);
            tpl[7] = new TupleClass("ExtraWrk", 80, MyTableColumn.TYPE_STRING);
        }
        return tpl;
    }
    ...
    private void showSelfReport() {
        try {
            ...
            contentPane.add(new SelfReport(this, "OverTimeApplet"), BorderLayout.CENTER);
    ...
    public void showMonthlyMuster(int index) {
        ...
        contentPane.add(new MonthlyMuster("OverTimeApplet", index), BorderLayout.CENTER);
        contentPane.validate();
        contentPane.repaint();
    }
}
