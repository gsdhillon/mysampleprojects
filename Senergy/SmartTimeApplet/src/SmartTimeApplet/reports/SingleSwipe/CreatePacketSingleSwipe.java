 ...
 * @author pradnya
 */
public class CreatePacketSingleSwipe {
    
    private SingleSwipeGUI MR;
    private String packet = "";
    
    public CreatePacketSingleSwipe(SingleSwipeGUI MR, String div, String section, String workL) {
        this.MR = MR;
        packet = Packet(div, section, workL);
    }
    
    public CreatePacketSingleSwipe(SingleSwipeGUI MR, String checkHead) {
        this.MR = MR;
        packet = Packet(checkHead);
    }
    
    public CreatePacketSingleSwipe(String[] name) throws Exception {
        packet = Packet(name);
    }
    ...
    private String Packet(String div, String section, String workL) {
        ...
        try {
            a.addString(GetDate(MR.picker1));
            a.addString(GetDate(MR.picker2));
            a.addString(div);
            a.addString(section);
            a.addString(workL);
        } catch (Exception ex) {
